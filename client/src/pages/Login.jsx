...
export default function Login() {
  ...
  const [mode, setMode] = useState('patient'); // 'patient' | 'doctor' | 'setup'
          ...
          {mode !== 'setup' && (
            <div style={{ display: 'flex', gap: '8px', marginBottom: '24px', background: '#f1f5f9', padding: '4px', borderRadius: '10px' }}>
              <button onClick={() => setMode('patient')} style={{
                ...
                background: mode === 'patient' ? 'white' : 'transparent',
                fontWeight: 700, fontSize: '14px', cursor: 'pointer', fontFamily: 'Cairo, sans-serif',
                color: mode === 'patient' ? '#1a3a6b' : '#64748b',
                boxShadow: mode === 'patient' ? '0 1px 4px rgba(0,0,0,0.1)' : 'none',
              }}>مريض</button>
              <button onClick={() => setMode('doctor')} style={{
                flex: 1, padding: '10px', border: 'none', borderRadius: '8px',
                background: mode === 'doctor' ? 'white' : 'transparent',
                fontWeight: 700, fontSize: '14px', cursor: 'pointer', fontFamily: 'Cairo, sans-serif',
                color: mode === 'doctor' ? '#1a3a6b' : '#64748b',
